...
//color
const colorObject = {};
colorObject.depthColor = "#72abca";
colorObject.surfaceColor = "#ffffff";
...
const material = new THREE.ShaderMaterial({
  ...
  uniforms: {
    uWaveLength: { value: 0.02 },
    uFrequency: { value: new THREE.Vector2(1.14, 2.5) },
    uTime: { value: 0.0 },
    ...
    uSmallWaveFrequency: { value: 1.237 },
    uSmallWaveSpeed: { value: 0.452 },
  },
});
